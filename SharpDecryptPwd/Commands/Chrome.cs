    ...
    public class Chrome : ICommand
    {
        ...
        public static string DecryptWithKey(byte[] encryptedData, byte[] MasterKey)
        {
            ...
            try
            {
                ...
                return Encoding.UTF8.GetString(Lib.Crypt.AesGcm.Decrypt(MasterKey, iv, null, data, tag));
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// A new MasterKey has been added in version 80 and above
        /// </summary>
